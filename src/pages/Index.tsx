...
const initialTasks: Task[] = [
  { 
    ...
    position: { x: 60, y: 100 },
    group: "group-1",
    createdAt: 1725152400000, // Sept 1, 2025
    subtasks: [
  ...
  { 
    ...
    position: { x: 480, y: 60 },
    group: "group-2",
    createdAt: 1726617600000, // Sept 18, 2025
    subtasks: [
  ...
  { 
    ...
    group: "group-3",
    createdAt: 1728240000000, // Oct 7, 2025
    subtasks: [
  ...
  { 
    ...
    group: "group-4",
    createdAt: 1729612800000, // Oct 22, 2025
    subtasks: [
  ...
  { 
    ...
    group: "group-5",
    createdAt: 1730851200000, // Nov 5, 2025
  },
  { 
    id: "T-018", 
    axisId: "AX-03", 
    ...
    group: "group-1",
    createdAt: 1731888000000, // Nov 18, 2025
    subtasks: [
  ...
  { 
    ...
    group: "group-2",
    createdAt: 1732838400000, // Nov 29, 2025
  },
];
